      ...
      <div >
        <div className='flex flex-row gap-10 w-[270px] h-[250px] '>
          ...
          <div className=''>
            ...
            <IoStar size={20} className='text-yellow-400' />
            <IoStar size={20} className='text-yellow-400' />
            <span className='text-gray-200'><h6>(88)</h6></span>
            </div>
          </div>
          </div>
          <div className='w-50 bg-gray-500 py-10 px-5'>
          ...
          <div className='w-50 bg-gray-500 py-10 px-5'>
            ...
            <IoStar size={20} className='text-yellow-400' />
            <IoStar size={20} className='text-yellow-400' />
            <span className='text-gray-200'><h6>(78)</h6></span>
            </div>
          </div>
          ...
          <div className='w-50 bg-gray-500 py-10 px-5'>
            <img src={Chair} alt='Chair' className='w-170 h-179 mx-auto'/>
            <h6>S-Series Comfort Chair</h6>
            <h6>$22 <s className='ml-2'>$30</s></h6>
            <div className='flex gap-3'>
            <IoStar size={20} className='text-yellow-400 ' />
            <IoStar size={20} className='text-yellow-400' />
            <IoStar size={20} className='text-yellow-400' />
            <IoStar size={20} className='text-yellow-400' />
            <IoStar size={20} className='text-yellow-400' />
            <span className='text-gray-200'><h6>(99)</h6></span>
            </div>
          </div>
